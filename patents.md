...
4. **Patient Invariant Model for Freezing of Gait Detection based on Empirical Wavelet Decomposition**<br>
   Inventors: Shivam Singhal, Nasimuddin Ahmed, <span style="color:#0066cc;"><strong>Varsha Sharma</strong></span>, Sakyajit Bhattacharya, Aniruddha Sinha, Avik Ghose<br>
...
5. **Discriminating features based sepsis prediction**<br>
   Inventors: <span style="color:#0066cc;"><strong>Varsha Sharma</strong></span>, C Bhattacharyya, T Bhattacharjee, M Poduval, S Khandelwal, Anirban Dutta Choudhury<br>
...
6. **Method and system for trip classification**<br>
   Inventors: <span style="color:#0066cc;"><strong>Varsha Sharma</strong></span>, Arijit Chowdhury<br>
